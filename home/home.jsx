            ...
            <div id="sidebar-area" className="sidebar-area">
                ...
                <div className="side-menu-content">
                    <div className="side-menu-logo">
                        ...
                        <a className="light-img" href="index.html"><img src="/assets/img/logo/logo-2.png" alt="logo" /></a>
                    </div>
            ...
            <div id="smooth-wrapper">
                <div id="smooth-content">
                    ...
                    <section className="hero-section">
                        <div className="hero-bg-shape"><img src="/assets/img/bg-img/hero-bg-shape.png" alt="shape" /></div>
                        ...
                        <div className="hero-img"><img src="/assets/img/images/hero-img.png" alt="hero" /></div>
                    ...
                    <section className="process-section pt-130 fade-wrapper">
                        <div className="bg-shape"><img src="/assets/img/shapes/process-shape.png" alt="shape" /></div>
                        <div className="container">
                    ...
                    <section className="about-section pb-130">
                        <div className="round-shape"><img src="/assets/img/shapes/round-shape.png" alt="shape" /></div>
                        <div className="about-wrap">
                            <div className="shape"><img src="/assets/img/shapes/about-dot-shape.png" alt="shape" /></div>
                    ...
                    <section className="service-section pb-130 fade-wrapper">
                        <div className="shape"><img src="/assets/img/shapes/service-shape-1.png" alt="shape" /></div>
                    ...
                    <section className="faq-section pt-130 pb-130">
                        <div className="faq-shape"><img src="/assets/img/shapes/faq-shape-1.png" alt="shape" /></div>
