...
export default function HomePage() {
    return (
        <>
            ...
            <div id="sidebar-area" className="sidebar-area">
                <button className="sidebar-trigger close">
                    <svg
                        ...
                        height="12.7px"
                        viewBox="0 0 16 12.7"
                        style={{ enableBackground: 'new 0 0 16 12.7' }} // camelCase style attribute
                    >
                        <g>
                            <rect
                                x="0"
            ...
            <div id="smooth-wrapper">
                <div id="smooth-content">
                    ...
                    <section className="hero-section">
                        <div className="hero-bg-shape"><Image src="assets/Image/bg-Image/hero-bg-shape.png" alt="shape" /></div>
                        <div className="hero-shape"><Image src="assets/Image/shapes/hero-shape-1.png" alt="shape" /></div>
                        <div className="hero-images">
                            <Image src="assets/Image/images/hero-Image-1.png" alt="hero" />
                            <Image src="assets/Image/images/hero-Image-2.png" alt="hero" />
                            <Image src="assets/Image/images/hero-Image-3.png" alt="hero" />
                        </div>
                        <div className="hero-Image"><Image src="assets/Image/images/hero-Image.png" alt="hero" /></div>
                        <div className="container">
                            <div className="hero-content">
                                ...
                                <a href="about.html" className="hero-btn"><i className="fa-thin fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </section>

                    <section className="process-section pt-130 fade-wrapper">
                        <div className="bg-shape"><Image src="assets/Image/shapes/process-shape.png" alt="shape" /></div>
                        <div className="container">
                            ...
                            <div className="row gy-lg-0 gy-5">
                                <div className="col-lg-3 col-md-6">
                                    <div className="process-item fade-top">
                                        <div className="process-icon">
                                            ...
                                            <Image className="dark-Image" src="assets/Image/icon/process-1.png" alt="icon" />
                                            <Image className="light-Image" src="assets/Image/icon/process-1-light.png" alt="icon" />
                                        </div>
                                ...
                                <div className="col-lg-3 col-md-6">
                                    <div className="process-item fade-top">
                                        <div className="process-icon">
                                            <div className="icon-border"></div>
                                            <Image className="dark-Image" src="assets/Image/icon/process-2.png" alt="icon" />
                                            <Image className="light-Image" src="assets/Image/icon/process-2-light.png" alt="icon" />
                                        </div>
                                        <div className="process-content">
                                ...
                                <div className="col-lg-3 col-md-6">
                                    <div className="process-item fade-top">
                                        <div className="process-icon">
                                            <div className="icon-border"></div>
                                            <Image className="dark-Image" src="assets/Image/icon/process-3.png" alt="icon" />
                                            <Image className="light-Image" src="assets/Image/icon/process-3-light.png" alt="icon" />
                                        </div>
                                        <div className="process-content">
                                ...
                                <div className="col-lg-3 col-md-6">
                                    <div className="process-item fade-top">
                                        <div className="process-icon">
                                            <div className="icon-border"></div>
                                            <Image className="dark-Image" src="assets/Image/icon/process-4.png" alt="icon" />
                                            <Image className="light-Image" src="assets/Image/icon/process-4-light.png" alt="icon" />
                                        </div>
                                        <div className="process-content">
                        ...
                        <div className="process-text wow fade-in-bottom" data-wow-delay="400ms">
                            <Image className="dark-Image" src="assets/Image/images/process-Image.png" alt="process" />
                            <Image className="process-Image-light light-Image" src="assets/Image/images/process-Image-light.png" alt="process" />
                        </div>
                    </section>

                    <section className="about-section pb-130">
                        <div className="round-shape"><Image src="assets/Image/shapes/round-shape.png" alt="shape" /></div>
                        <div className="about-wrap">
                            <div className="shape"><Image src="assets/Image/shapes/about-dot-shape.png" alt="shape" /></div>
                                ...
                                <div className="col-lg-7">
                                    <div className="about-content fade-wrapper">
                                        <div className="section-heading mb-0">
                                            ...
                                            <h2 className="section-title overflow-hidden" data-text-animation data-split="word" data-duration="1">Wefff provide best web design <br />solution in city</h2>
                                            ...
                                            <a href="about.html" className="rr-primary-btn">Get Started Now<i className="fa-regular fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-5">
                                    <div className="about-Image-wrap">
                                        ...
                                        <div className="about-Image reveal">
                                            <Image className="Image-1" src="assets/Image/images/about-Image.jpg" alt="Image" />
                                        </div>
                                        <div className="about-Image-2 reveal">
                                            <Image className="Image-2" src="assets/Image/images/about-Image-1.jpg" alt="Image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="about-text">
                                <Image className="dark-Image" src="assets/Image/images/about-text.png" alt="about" />
                                <Image className="light-Image" src="assets/Image/images/about-text-light.png" alt="about" />
                            </div>
                        </div>
                    </section>

                    <section className="service-section pb-130 fade-wrapper">
                        <div className="shape"><Image src="assets/Image/shapes/service-shape-1.png" alt="shape" /></div>
                            ...
                            <div className="row gy-lg-0 gy-4">
                                <div className="col-lg-3 col-md-6">
                                    <div className="service-item md-pb-30 fade-top">
                                        <h4 className="service-text"><a href="service-details.html">/Designing</a></h4>
                                        <div className="service-thumb">
                                            <div className="overlay-color"></div>
                                            <div className="transparent-shape"><Image src="assets/Image/shapes/service-shape.png" alt="shape" /></div>
                                            <Image src="assets/Image/service/service-2.jpg" alt="service" />
                                            ...
                                            <a href="service-details.html" className="service-btn">Read Details <i className="fa-regular fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-6">
                                    <div className="service-item md-pb-30 fade-top">
                                        <h4 className="service-text"><a href="service-details.html">/Development</a></h4>
                                        <div className="service-thumb">
                                            <div className="overlay-color"></div>
                                            <div className="transparent-shape"><Image src="assets/Image/shapes/service-shape.png" alt="shape" /></div>
                                            <Image src="assets/Image/service/service-1.jpg" alt="service" />
                                            <div className="service-icon">
                                ...
                                <div className="col-lg-3 col-md-6">
                                    <div className="service-item item-3 fade-top">
                                        <h4 className="service-text"><a href="service-details.html"> /User Experience</a></h4>
                                        <div className="service-thumb">
                                            <div className="overlay-color"></div>
                                            <div className="transparent-shape"><Image src="assets/Image/shapes/service-shape.png" alt="shape" /></div>
                                            <Image src="assets/Image/service/service-3.jpg" alt="service" />
                                            <div className="service-icon">
                                                <svg width="50" height="50" viewBox="0 0 50 50" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="col-lg-3 col-md-6">
                                    <div className="service-item fade-top">
                                        <h4 className="service-text"><a href="service-details.html">  /Mobile Solution</a></h4>
                                        <div className="service-thumb">
                                            <div className="overlay-color"></div>
                                            <div className="transparent-shape"><Image src="assets/Image/shapes/service-shape.png" alt="shape" /></div>
                                            <Image src="assets/Image/service/service-4.jpg" alt="service" />
                                            <div className="service-icon">
                                                <svg width="51" height="50" viewBox="0 0 51 50" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <section className="faq-section pt-130 pb-130">
                        <div className="faq-shape"><Image src="assets/Image/shapes/faq-shape-1.png" alt="shape" /></div>
                        ...
                        <div className="container">
                            <div className="row gy-lg-0 gy-4">
                                <div className="col-xl-6 col-lg-12 col-md-12">
                                    <div className="faq-content">
                                        <div className="section-heading">
                                            ...
                                            <h2 className="section-title" data-text-animation data-split="word" data-duration="1">Digital Solution That Improve Your Agency Growth</h2>
                                        </div>
                                ...
                                <div className="col-xl-6 col-lg-12 col-md-12">
                                    <div className="faq-Image reveal text-center">
                                        <Image src="assets/Image/images/faq-Image.png" alt="faq" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="testi-item text-center">
                                            ...
                                            <div className="testi-content">
                                                <h3 className="author">Nicholas Thomas <span>Designer</span></h3>
                                                <p>Curabitur accumsan nec aliquam mauris placat primis lacinia egestas congue facilisis ligula leo sociosqu consequat</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="swiper-slide">
                                        <div className="testi-item text-center">
                                            <div className="testi-thumb">
                                                <Image src="assets/Image/testi/testi-author-5.png" alt="Image" />
                                            </div>
                                            <div className="testi-content">
                                                <h3 className="author">James Hallagher <span>Marketer</span></h3>
                                                <p>Curabitur accumsan nec aliquam mauris placat primis lacinia egestas congue facilisis ligula leo sociosqu consequat</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="swiper-slide">
                                        <div className="testi-item text-center">
                                            <div className="testi-thumb">
                                                <Image src="assets/Image/testi/testi-author-6.png" alt="Image" />
                                            </div>
                                            <div className="testi-content">
                                                <h3 className="author">Amelia Harper <span>Owner</span></h3>
                                                <p>Curabitur accumsan nec aliquam mauris placat primis lacinia egestas congue facilisis ligula leo sociosqu consequat</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <section className="project-section pt-130 pb-130">
                        <div className="container">
                            <div className="project-top heading-space align-items-end">
                                ...
                                <a href="project.html" className="rr-primary-btn">View More Project<i className="fa-regular fa-arrow-right"></i></a>
                            </div>
                                            ...
                                            <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                <span className="project-content">
                                                    ...
                                                    <span className="project-right">
                                                        ...
                                                        <span className="title">Marketing Solution For Brand</span>
                                                    </span>
                                                </span>
                                            </button>
                                        </h2>
                                            ...
                                            <div className="accordion-body">
                                                <div className="hover-content">
                                                    <div className="content-left">
                                                        ...
                                                        <a href="project-details.html" className="rr-primary-btn">View Details<i className="fa-regular fa-arrow-right"></i></a>
                                                    </div>
                                                    <div className="content-right">
                                                        <div className="project-thumb">
                                                            <Image src="assets/Image/project/project-1.png" alt="" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                <span className="project-content">
                                                    ...
                                                    <span className="project-right">
                                                        ...
                                                        <span className="title">Sass Mobile Dashboard Design</span>
                                                    </span>
                                                </span>
                                            </button>
                                        </h2>
                                            ...
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#projectCollapseFour" aria-expanded="false" aria-controls="projectCollapseFour">
                                                <span className="project-content">
                                                    ...
                                                    <span className="project-right">
                                                        ...
                                                        <span className="title">Medical Website Development</span>
                                                    </span>
                                                </span>
                                            </button>
                                        </h2>
                        ...
                        <div className="container">
                            ...
                            <div className="post-wrap">
                                <div className="post-card-wrap fade-top">
                                    <div className="post-card">
                                        <div className="post-thumb">
                                            <Image src="assets/Image/blog/post-1.jpg" alt="post" />
                                        </div>
                                        <div className="post-content-wrap">
                                            <div className="post-content">
                                                ...
                                                <h3 className="title"><a href="blog-details.html">The Future-Focused Strategies of Our Forward-Thinking Web Design Agency</a></h3>
                                                <a href="blog-details.html" className="rr-primary-btn blog-btn">Read More <i className="fa-sharp fa-regular fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="post-card-wrap fade-top">
                                    <div className="post-card">
                                        <div className="post-thumb">
                                            <Image src="assets/Image/blog/post-2.jpg" alt="post" />
                                        </div>
                                        <div className="post-content-wrap">
                                            <div className="post-content">
                                                <ul className="post-meta">
                                                ...
                                                <h3 className="title"><a href="blog-details.html">A Deep Dive into the Impactful Branding Strategies of Our Web Design Agency</a></h3>
                                                <a href="blog-details.html" className="rr-primary-btn blog-btn">Read More <i className="fa-sharp fa-regular fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="post-card-wrap fade-top">
                                    <div className="post-card">
                                        <div className="post-thumb">
                                            <Image src="assets/Image/blog/post-3.jpg" alt="post" />
                                        </div>
                                        <div className="post-content-wrap">
                                            <div className="post-content">
                                                <ul className="post-meta">
                                                ...
                                                <h3 className="title"><a href="blog-details.html">How Our Web Design Agency Ensures Your Website Rises to the Top of Search Rankings</a></h3>
                                                <a href="blog-details.html" className="rr-primary-btn blog-btn">Read More <i className="fa-sharp fa-regular fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="container">
                            <div className="sponsor-wrap">
                                <div className="sponsor-item item-1">
                                    <h3 className="title">WORKED WITH <br />GLOBAL LARGEST <br /> BRANDS</h3>
                                </div>
                                <div className="sponsor-item">
                                    <a href="#"><Image src="assets/Image/sponsor/sponsor-1.png" alt="sponsor" /></a>
                                </div>
                                <div className="sponsor-item">
                                    <a href="#"><Image src="assets/Image/sponsor/sponsor-2.png" alt="sponsor" /></a>
                                </div>
                                <div className="sponsor-item">
                                    <a href="#"><Image src="assets/Image/sponsor/sponsor-3.png" alt="sponsor" /></a>
                                </div>
                                <div className="sponsor-item">
                                    <a href="#"><Image src="assets/Image/sponsor/sponsor-4.png" alt="sponsor" /></a>
                                </div>
                            </div>
                        </div>
                    </section>
            ...
            <div id="theme-toogle" className="switcher-button" aria-label="">
